...
export class Home extends Component<Record<string, unknown>, IState> {
  ...
  render(): JSX.Element {
    return (
      <>
        <div ref={this.stageRef} className="fixed top-0 left-0 w-screen h-screen" style={{ zIndex: -1000 }}></div>
