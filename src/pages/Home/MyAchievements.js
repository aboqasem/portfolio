...
const MyAchievements = () => {
  return (
      <MyHomeSection theme={tLightTheme} title={"Achievements"}>
                ...
                <ListItem alignItems={"flex-start"}>
                  ...
                  <ListItemIcon>
                    <Button variant={"outlined"} href={value.url} target={"_blank"}
                      ...
                      <img src={value.logoUrl} alt={""} style={listItemIconImgStyle}/>
                    </Button>
                    {/* Responsive sized box */}
                    <Box width={"min(4vw, 35px)"}/>
                  </ListItemIcon>

                  <ListItemText primary={value.achievement} secondary={
